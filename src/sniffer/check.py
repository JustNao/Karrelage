...
def check_for_update():
    ...
    cloud_version = rq.get(
        "https://8118-2a01-cb00-dcf-1000-4868-1b39-aa24-9c02.ngrok-free.app/DOFUS_VERSION"
    )
    ...
    if cloud_version != current_saved_version:
        ...
        packets = rq.get(
            "https://8118-2a01-cb00-dcf-1000-4868-1b39-aa24-9c02.ngrok-free.app/protocol.pk",
        )
